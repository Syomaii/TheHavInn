...
namespace TheHavInn
{
    public partial class ClassicRoomB : Form
    {
        private OleDbConnection connection;
        private string roomNumber;
        public ClassicRoomB(string roomNumber)
        {
            InitializeComponent();
        ...
        private void btn3_Click(object sender, EventArgs e)
        {
            ...
            string updateStatusQuery = "UPDATE [HavinnRooms_B] SET [RoomStatus_B] = 'OCCUPIED' WHERE [RoomNumber_B] = ?";
        ...
        private void ClassicRoomB_FormClosing(object sender, FormClosingEventArgs e)
        {
