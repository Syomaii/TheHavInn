...
namespace TheHavInn
{
    public partial class ClassicRoomC : Form
    {
        private OleDbConnection connection;
        private string roomNumber;
        public ClassicRoomC(string roomNumber)
        {
            InitializeComponent(); 
        ...
        private void btn3_Click(object sender, EventArgs e)
        {
            ...
            string updateStatusQuery = "UPDATE [HavinnRooms_C] SET [RoomStatus_C] = 'OCCUPIED' WHERE [RoomNumber_C] = ?";
        ...
        private void ClassicRoomC_FormClosing(object sender, FormClosingEventArgs e)
        {
